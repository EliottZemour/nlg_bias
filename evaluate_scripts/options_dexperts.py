...
def evaluate_options():
    ...
    parser.add_argument("--expert_model", default='eliolio/gpt2-finetuned-religion-reddit-antibias', type=str,
                        help='model to generate sentences')
    parser.add_argument("--antiexpert_model", default='eliolio/gpt2-finetuned-religion-redditbias', type=str,
                        help='model to generate sentences')
